...
def render_dashboard_content(df_master):
    ...
    with tab1:
        st.plotly_chart(build_precision_graph(df_master, 'Real 450nm', "Chlorophyll Concentration"), use_container_width=True)
        st.plotly_chart(build_precision_graph(df_master, 'Real 750nm', "Cell Density"), use_container_width=True)
